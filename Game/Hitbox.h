...
public:
	...
	Point getCenter();
	Line getMaximumClearDistanceForVectorFromGameObject(std::vector<GameObject*> objects, Line vector);
...
private:
	...
	static vector<Point> getEquallySpacedPointsAlongLine(Point origin, Line a, int pts);
